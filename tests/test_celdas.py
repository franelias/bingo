...
def test_contar_celdas_ocupadas():
    ...
    assert validar_quince_numeros(carton_valido_programa)
...
def test_menos_de_15_celdas_ocupadas():
    ...
    assert validar_menos_quince_numeros(carton_valido_programa)
...
def test_mas_de_15_celdas_ocupadas():
    ...
    assert validar_mas_quince_numeros(carton_valido_programa)
...
def test_validar_uno_a_noventa():
    ...
    assert validar_numeros_carton(carton_valido_programa)
