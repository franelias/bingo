...
def test_fila_5_celdas_ocupadas():
    ...
    assert fila_5_celdas_ocupadas(carton_valido_programa)
...
def test_filas_celdas_consecutivas_vacias():
    ...
    assert filas_2_celdas_consecutivas_vacias_o_ocupadas(carton_valido_programa)
...
def test_revisar_filas_ocupadas():
    ...
    assert revisar_filas_ocupadas(carton_valido_programa)
